...
document.getElementsByClassName("navbar")[0].innerHTML = `<a href="${deepPath ? "../" : ""}${very ? "../" : ""}index.html"><img src="${deepPath ? "../" : ""}${very ? "../" : ""}assets/logo.png" width=45 height=45 style="position: relative; top: 8px; left: 20px;"/><span class="navtitle" style="position: relative; left: 35px;">Netcade</span></a>
		<div class="navlist" style="display: inline; position: relative; left: 60px;">
			...
			<a href="https://github.com/WintrCat"><div class="navitem"><span class="navitem">GitHub</span></div></a>
